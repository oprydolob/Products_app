...
class ManufacturersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create manufacturer" do
    assert_difference('Manufacturer.count') do
      post manufacturers_url, params: { manufacturer: { country: @manufacturer.country, date_of_foundation: @manufacturer.date_of_foundation, name: @manufacturer.name } }
    end
  ...
  test "should update manufacturer" do
    patch manufacturer_url(@manufacturer), params: { manufacturer: { country: @manufacturer.country, date_of_foundation: @manufacturer.date_of_foundation, name: @manufacturer.name } }
